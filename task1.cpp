...
int main() {
    ...
    printf("Программа выполняет генерацию 13 целых значений в диапазоне от 20 до 60, заполняет ими массив, сортирует его методом сдвига и показывает результат");
